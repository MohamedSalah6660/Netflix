    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        ...
        <div class="container">
            ...
            <a class="navbar-brand" href="{{ url('/') }}">Net<span class="text-primary font-weight-bold">flix</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    @auth
                        ...
                        <li class="nav-item mr-3">
                            ...
                            <a href="{{ route('movies.index', ['favorite' => 1]) }}" class="nav-link text-white" style="position: relative; ">
                                ...
                                <i class="fa fa-heart fa-lg" style="width: 150%;"></i>

                                <span class="bg-primary text-white d-flex justify-content-center align-items-center" style="position:absolute; top: 0; right: -15px; width: 28px; height: 18px; border-radius: 50px;"
                                  id="nav__fav-count" 
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="{{ route('dashboard.welcome') }}"><i class="fa fa-tachometer"></i> Dashboard 
                </a>
