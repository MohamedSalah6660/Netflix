                ...
                <div class="col-md-4 text-white">
                  ...
                  @auth
                    ...
                    <a href="" class="btn btn-primary text-capitalize my-3 movie__fav-btn">
                         ...
                         <span class="fa fa-heart movie__fav-icon movie-{{ $movie->id }}
                             {{ $movie->is_favored ? 'fw-900' : '' }}"
           	...
           	@foreach($related_movies as $related_movie)
                ...
                <div class="movie__details text-white">
                    ...
                    <div class="movie___views">
                        <p>Views: <span id="movie__views">{{ $related_movie->views }}</span></p>
                    </div>
					...
					@auth
 					 ...
 					 <i class="fa fa-heart {{ $related_movie->is_favored ? 'fw-900' : '' }}  align-self-center movie__fav-icon movie-{{ $related_movie->id }}"
					...
					<a href="{{ route('login') }}"><i class="fa fa-heart fa-1x align-self-center movie__fav-icon"></i></a>
					@endauth
