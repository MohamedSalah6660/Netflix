                    ...
                    @foreach ($movies as $movie)
                        ...
                        <div class="movie col-md-3  my-3 p-0">
                            ...
                            <div class="movie__details text-white">
                                ...
                                <div class="d-flex movie__cta" style="width: 90%;">
                                    <a href="{{ route('movies.show', $movie->id) }}" class="btn btn-primary text-capitalize flex-fill mr-1" ><i class="fa fa-play"></i> watch now</a>
                                    @auth
